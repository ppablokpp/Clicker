...
export const translations: Record<Language, TranslationStrings> = {
  es: {
    ...
    tree: {
      ...
      luckName: 'Filón',
      luckDesc: 'Cada disparo tiene una probabilidad de encontrar un filón y multiplicar su potencia.',
  ...
  en: {
    ...
    tree: {
      ...
      luckName: 'Vein',
      luckDesc: 'Each shot has a chance to find a vein and multiply its power.',
