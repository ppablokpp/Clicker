...
export const translations: Record<Language, TranslationStrings> = {
  es: {
    ...
    tree: {
      ...
      luckName: 'Filón',
      luckDesc: 'Cada disparo tiene una probabilidad de alcanzar un filón rico y multiplicar el platino obtenido.',
      multiplierName: 'Potencia de disparo',
      multiplierDesc: 'Aumenta el platino que arranca cada disparo. Cada nivel suma encima del valor actual.',
      currentClickValue: 'Platino por disparo actual:',
      nextClickValue: 'Platino por disparo siguiente nivel:',
      luckChanceName: 'Escáner',
      luckChanceDesc: 'Aumenta la probabilidad de detectar un filón al disparar.',
      ...
      legendaryGrowthDesc: 'Aumenta cuánto sube el bonus del modo Legendario cada vez que se llena la barra de combo.',
      currentBonusStep: 'Subida actual:',
      nextBonusStep: 'Subida siguiente nivel:',
      fortunaName: 'Dron buscador',
      fortunaDesc: 'Tus drones tienen una probabilidad de encontrar un filón extra al minar.',
      azarName: 'Frecuencia',
      azarDesc: 'Sintoniza el radar de tus drones, aumentando la probabilidad de que encuentren un filón.',
      ...
      tapMultiplierDesc: 'Multiplica la potencia de cada disparo. Cada nivel sube el multiplicador un poco más.',
  ...
  en: {
    ...
    tree: {
      ...
      luckName: 'Vein',
      luckDesc: 'Each shot has a chance to strike a rich vein and multiply the platinum earned.',
      multiplierName: 'Blast Power',
      multiplierDesc: "Raises the platinum each shot breaks loose. Each level adds on top of the current value.",
      currentClickValue: 'Current platinum per shot:',
      nextClickValue: 'Next level platinum per shot:',
      luckChanceName: 'Scanner',
      luckChanceDesc: "Raises the odds of detecting a vein when you fire.",
      ...
      legendaryGrowthDesc: "Raises how much Legendary's bonus increases each time the combo bar fills.",
      currentBonusStep: 'Current increase:',
      nextBonusStep: 'Next level increase:',
      fortunaName: 'Scout Drone',
      fortunaDesc: "Your drones have a chance to find an extra vein while mining.",
      azarName: 'Frequency',
      azarDesc: "Tunes your drones' radar, raising the odds they find a vein.",
      turboName: 'Overload',
      turboDesc: "Overloads your drones' reactor, guaranteeing a multiplier on their production.",
      tapMultiplierName: 'Amplifier',
      tapMultiplierDesc: "Multiplies the power of each shot. Each level raises the multiplier a bit further.",
