...
export const translations: Record<Language, TranslationStrings> = {
  es: {
    ...
    profile: {
      ...
      signedOutBody: 'Tu progreso ya se está guardando en este dispositivo. Inicia sesión para ponerle nombre, salir en la clasificación y no perderlo si cambias de móvil u ordenador.',
  ...
  en: {
    ...
    profile: {
      ...
      signedOutBody: 'Your progress is already being saved on this device. Sign in to give it a name, show up on the leaderboard, and keep it safe if you switch phones or computers.',
      signIn: 'Sign in',
