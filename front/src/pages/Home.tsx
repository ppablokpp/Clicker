  ...
  return (
    <div className="pointer-events-none absolute inset-0">
      {Array.from({ length: totalUnits }, (_, i) => {
        ...
        // changed (index.css: base ring ×0.79, the big ring another ×1.43
        ...
        // looked before either ring's radius changed. Keep the 1.43 in
        // sync with --drone-orbit-radius-big's own multiplier in index.css.
        const orbitDuration = (18 + (i % 3) * 3) * 0.79 * (big ? 1.43 : 1)
