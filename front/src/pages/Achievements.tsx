...
const UPCOMING = [
  { icon: Target, title: 'Hitos de clicks', desc: 'Desbloquea logros al llegar a ciertas cifras totales.' },
  { icon: Flame, title: 'Rachas', desc: 'Recompensas por jugar días seguidos.' },
  { icon: Trophy, title: 'Insignias de ranking', desc: 'Logros por posición en la clasificación mensual.' },
]
    ...
    <div className="min-h-[100dvh] w-full bg-[#08080c] px-4 pb-24 pt-6 sm:px-6 sm:pb-10 sm:pt-24">
      <div className="mx-auto max-w-2xl">
        <header className="mb-8">
          <h1 className="font-[Space_Grotesk] text-2xl font-bold text-white sm:text-3xl">Logros</h1>
          <p className="mt-1 text-sm text-neutral-500">Todavía no hay logros activos, pero esto es lo que viene.</p>
        </header>
