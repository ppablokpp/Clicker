 ...
 * radio handset hung on its bracket beside the platino screen: antenna
 * with a brass tip, the little glass display with a trace across it, the
 * speaker grille, the brass talk button on the side, the volume knob.
 * Framed to the same box as the diary across from it and painted like it — the
 * cover's purple, the leaves' cream, a violet LED — so the two read as one
 * set of instruments.
 *
  ...
  return (
    ...
    >
      <svg viewBox="0 0 64 80" className="h-full max-h-[72px] w-auto overflow-visible" aria-hidden="true">
        ...
        {/* Framed to the diary's box across the screen: the antenna's tip
            at the top of it (y 2), the body's foot at the bottom (y 78),
            the body centred, as narrow as a handset is. */}
