...
export const COSMETIC_CATALOG: CosmeticCaseItem[] = [
  ...
  { slot: 'bracelet', id: 'zafiro', rarity: 'consumer' },
  ...
  { slot: 'bracelet', id: 'cuarzo', rarity: 'milspec' },
  { slot: 'bracelet', id: 'rubi', rarity: 'milspec' },
  { slot: 'bracelet', id: 'diamante', rarity: 'restricted' },
  { slot: 'bracelet', id: 'oro', rarity: 'restricted' },
  { slot: 'belt', id: 'zafiro', rarity: 'consumer' },
  { slot: 'belt', id: 'grafito', rarity: 'consumer' },
  { slot: 'belt', id: 'carmesi', rarity: 'consumer' },
  { slot: 'belt', id: 'esmeralda', rarity: 'milspec' },
  { slot: 'belt', id: 'cuarzo', rarity: 'milspec' },
  { slot: 'belt', id: 'rubi', rarity: 'milspec' },
  { slot: 'belt', id: 'diamante', rarity: 'restricted' },
  { slot: 'belt', id: 'oro', rarity: 'restricted' },
  { slot: 'accent', id: 'zafiro', rarity: 'consumer' },
  { slot: 'accent', id: 'grafito', rarity: 'consumer' },
  { slot: 'accent', id: 'carmesi', rarity: 'consumer' },
  { slot: 'accent', id: 'esmeralda', rarity: 'milspec' },
  { slot: 'accent', id: 'cuarzo', rarity: 'milspec' },
  { slot: 'accent', id: 'rubi', rarity: 'milspec' },
