 ...
 * an Anomalía pays out when neutralized. Level 0 (not owned) is the 1%
 ...
 * adds another flat 0.5%, capped at 5%.
 */
export const ANOMALY_REWARD_NODE_ID = 'anomaly_reward'
export const ANOMALY_REWARD_MAX_LEVEL = 8

export const ANOMALY_REWARD_BASE_PCT = 0.01
