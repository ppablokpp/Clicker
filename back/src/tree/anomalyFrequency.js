/**
 * Detección — Anomalías' other child. Shrinks the wait between Anomalía
 * spawns (Home.tsx's own spawn timer reads this). Level 0 (not owned) is
 * the 5-minute cadence everyone gets just from having Anomalías unlocked —
 * same "level 0 is a real floor, not zero" shape as luckChance.js/
 * anomalyReward.js. Each level shaves off another 30 seconds, down to a
 * 30-second floor.
 */
export const ANOMALY_FREQUENCY_NODE_ID = 'anomaly_frequency'
export const ANOMALY_FREQUENCY_MAX_LEVEL = 9

export const ANOMALY_FREQUENCY_BASE_SECONDS = 300
export const ANOMALY_FREQUENCY_STEP_SECONDS = 30
