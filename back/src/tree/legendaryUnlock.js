 ...
 * (Home.tsx's HEAT_LEVELS, min: 20 cps). Until this is bought, hitting 20
 * t/s caps out at the Imparable tier instead — no combo meter, no per-tier
 * multiplier. A single flat purchase, not a level ladder like every other
 * node here: there's nothing to scale, it's just on or off.
 */
