...
export const TASKS = [
  ...
  { id: 'drone_squadron', missionId: 'drones', tier: 2, type: 'node-level', nodeId: AUTOCLICK_NODE_ID, requiredLevel: 10, reward: 10_000 },
  ...
  { id: 'total_arsenal', missionId: 'multishot', tier: 3, type: 'node-level', nodeId: MULTI_SHOT_NODE_ID, requiredLevel: 9, reward: 40_000 },
  ...
  { id: 'scout_squad', missionId: 'scout', tier: 2, type: 'node-level', nodeId: SCOUT_DRONE_NODE_ID, requiredLevel: 10, reward: 25_000 },
  ...
  { id: 'anomaly_hunter', missionId: 'anomaly', tier: 2, type: 'counter', counterField: 'anomalies_neutralized', requiredCount: 5, reward: 20_000 },
  { id: 'sector_guardian', missionId: 'anomaly', tier: 3, type: 'counter', counterField: 'anomalies_neutralized', requiredCount: 15, reward: 75_000 },
]
